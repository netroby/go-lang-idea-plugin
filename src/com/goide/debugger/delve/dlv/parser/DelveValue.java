...
/**
 * Class representing a variable value read from a  stream.
 */
public class DelveValue {
  /**
   ...
   */
  public List<DelveResult> tuple;

  /**
   * List. Will be null if type is not List.
   */
  public DelveList list;
